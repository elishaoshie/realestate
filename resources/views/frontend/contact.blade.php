...
<body>
  ...
  <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    <div class="container">
      ...
      <a class="navbar-brand text-brand" href="index.html">F&C<span class="color-b">PROTY</span></a>
              ...
              <div class="icon-box section-b2">
                ...
                <div class="icon-box-content table-cell">
                  ...
                  <div class="icon-box-content">
                    <p class="mb-1">Email.
                      <span class="color-a">fcproty@gmail.com</span>
                    </p>
                    <p class="mb-1">Phone.
                      <span class="color-a">+234 90 144 016 00</span>
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div class="col-md-12">
          ...
          <div class="copyright-footer">
            <p class="copyright color-text-a">
              &copy; Copyright
              <span class="color-a">F&C</span> PROTY.
            </p>
          </div>
          <div class="credits">
            
            Designed by <a href="https://bootstrapmade.com/">F&C PROTY</a>
          </div>
        </div>
      </div>
    </div>
